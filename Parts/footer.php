...
<div id="footer_top">
    ...
    <div id="footer_bot">
    	<span id="footer_allrights">All Rights Reserved - Sathara Group of Services</span> <br>
        <a href="#"><span id="footer_bydeen">Design, Develop, Maintain By Deen Technologies</span></a>
    </div>
    </div>