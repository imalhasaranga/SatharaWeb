            ...
            <div id="push1">
                ...
                <table width="75%" border="1" cellspacing="0" cellpadding="0" style="margin-top:10px">
                    <tr>
                        ...
                        <td width="6%"  align="center" bgcolor="#CCCCCC">To Front</td>      
                    </tr>

                    <?php
                    $result = Db::SqlQuery("select* from book left join book_grade on book.Book_grade = book_grade.Book_grade_id  order by mag_or_bok  ");
                    while ($arry = mysql_fetch_array($result)) {
                        ?>
                        <tr>  
                            ...
                            <td align="center" bgcolor="<?php echo $bgcollor ?>"><a href="logics/frontmaker.php?id=<?php echo $arry["Book_ID"] ?>&state=<?php echo $arry["show_type"] ?>" ><?php echo $namx ?></a></td>                       	
                        </tr>
                    <?php } ?>                  
                </table>
              <p>&nbsp;</p>
              <p><strong>Note :- &quot;To Front&quot; Column Should have only 3 &quot;Back&quot; values in order to show them in front of the &quot;publihsers&quot; </strong><br/>
              </p>
            <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
